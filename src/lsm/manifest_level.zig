...
pub fn ManifestLevelType(
    ...
    return struct {
        ...
        pub const Keys = SortedSegmentedArray(
            ...
            Key,
            struct {
                fn key_from_value(value: *const Key) Key {
                    return value.*;
                }
            }.key_from_value,
            compare_keys,
...
pub fn TestContext(
    ...
    return struct {
        ...
        fn insert_tables(context: *Self) !void {
            ...
            const count_max = std.math.min(count_free, 13);
        ...
        fn random_greater_non_overlapping_table(context: *Self, key: Key) TableInfo {
            ...
            const max_delta = std.math.min(32, next_key_min - 1 - new_key_min);
        ...
        fn delete_tables(context: *Self) !void {
            ...
            const count_max = std.math.min(reference_len, 13);
            const count = context.random.uintAtMostBiased(u32, count_max - 1) + 1;
