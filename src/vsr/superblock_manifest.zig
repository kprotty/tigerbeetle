...
pub const Manifest = struct {
    ...
    pub fn encode(manifest: *const Manifest, target: []align(@alignOf(u128)) u8) u64 {
        ...
        util.copy_disjoint(
            .exact,
            u128,
            mem.bytesAsSlice(u128, @alignCast(@alignOf(u128), trees)),
        ...
        util.copy_disjoint(
            .exact,
            u128,
            mem.bytesAsSlice(u128, @alignCast(@alignOf(u128), checksums)),
        ...
        util.copy_disjoint(
            .exact,
            u64,
            mem.bytesAsSlice(u64, @alignCast(@alignOf(u128), addresses)),
